...
export default class Engine {
  ...
  scene: CrossyScene;
  gameMap: CrossyGameMap;
  camera: CrossyCamera;
  camCount: number;
  _hero: CrossyPlayer;
  renderer: CrossyRenderer;

  constructor() {
    this.camCount = 0; // Inisialisasi camCount
  }
  ...
  setupGame = (character) => {
    this.scene = new CrossyScene({}); // Inisialisasi scene
    this.camera = new CrossyCamera(); // Inisialisasi camera
